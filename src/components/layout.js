...
const Layout = ({title, children, pageContext }) => {
  ...
  return (
    <Fragment>
      ...
      {/*    </div>*/}
      {/*  </div>}*/}
      <div className={layoutStyles.overlay} style={(typeof getCookie('city-afterfit') !== 'undefined' && getCookie('city-afterfit'))  || (typeof overlay !== 'undefined' && !overlay) ? {display: 'none'} : null}>
