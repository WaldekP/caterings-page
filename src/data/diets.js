...
export const diets = [
  {
    ...
    dietId: 581,
    metaDescription:
      "Dieta bezglutenowa jest idealna dla każdego, kto chce się zdrowo odżywiać i nie toleruje glutenu.",
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dedykowana osobom z alergią, nadwrażliwością i nietolerancją na
            gluten.
            <br /> <br />
            2.Może być zalecana w chorobach autoimmunologicznych w tym Hashimoto
            a także w chorobach nieswoistych zapaleń jelit
            <br /> <br />
            3. Dla osób, którym po spożyciu produktów z glutenem towarzyszą
            objawy min. wzdęcia, bóle brzucha, nudności i wymioty, uczucie
            pełności, zaparcia czy gazy
            <br /> <br />
          </span>
        ),
      },
    ...
    menu: {
      ...
      dinner:
        "Schab z suszonymi pomidorami podany z sałatką z buraczka i pieczonymi talarkami ziemniaczanymi",
  ...
  },
  {
    ...
    dietId: 582,
    metaDescription:
      "Dieta bezlaktozowa jest idealna dla każdego, kto chce się zdrowo odżywiać i nie toleruje laktozy.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_3.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_14.jpg",
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Skierowana do osób nietolerujących laktozy.
            <br /> <br />
            2. Dla osób, którym po spożyciu produktów mlecznych towarzyszy
            uciążliwe uczucie dyskomfortu min. wzdęcia, bóle brzucha, kolki,
            zaparcia, gazy, biegunki.
            <br /> <br />
            3. Dla osób, które zrezygnowały z jedzenia nabiału.
            <br />
          </span>
        ),
      },
  ...
  },
  {
    ...
    dietId: 580,
    metaDescription:
      "Dieta przeznaczona jest dla osób, które chcą oczyścić organizm z toksyn i zbędnych produktów przemiany materii.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_3.jpg",
    ...
    questions: {
      1: {
        question: "Rozkład makroskładników",
        answer:
          "W diecie detox nie liczymy makroskładników. Jest to dieta , która powinna być stosowana tylko przez krótki okres. Optymalny czas to 1-3 tygodnie.",
      },
      2: {
        question: "Dla kogo?",
        answer: (
          <span>
            1. Dedykowana osobom, które są w ciągłym biegu, czują się
            wyczerpane, ociężałe, pozbawione energii do życia.
            <br /> <br />
            2. Dla osób które chcą oczyścić swój organizm z toksyn, wspomóc
            system trawienny oraz odpornościowy.
            <br /> <br />
            3. Skierowana dla osób, które chcą w szybki sposób zrzucić kilka
            kilogramów.
            <br /> <br />
          </span>
        ),
  ...
  },
  {
    ...
    dietId: 579,
    metaDescription:
      "Dieta z niskim indeksem glikemicznym przeznaczona jest dla osób , które mają problemy z nieprawidłowym poziom glukozy we krwi.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_3.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_9.jpg",
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dedykowana osobom, które chcą zacząć odżywiać się zdrowo i pragną
            zapanować nad niekontrolowanymi napadami głodu.
            <br /> <br />
            2. Skierowana dla osób cierpiących na cukrzycę, insulinooporość,
            choroby ze strony układu krążenia.
            <br /> <br />
            3. Zalecana osobom, które chcą zrzucić zbędne kilogramy.
            <br /> <br />
          </span>
        ),
      },
    ...
    menu: {
      ...
      secondBreakfast: "Smoothie bowl z ananasem i granolą",
      dinner:
        "Filet z indyka w winnym sosie śliwkowym z kaszą jaglaną i kalafiorem",
      tea: "Spring rolls z mango",
      supper: "Bakłażan  faszerowany mozarellą i pomidorami",
    },
    offerDescription:
      "Dieta dla osób, które mają problemy z nieprawidłowym poziomem glukozy we krwi.",
    cityDescription: {
      lodz: {
        description: [
  ...
  },
  {
    ...
    dietId: 124,
    metaDescription:
      "Dieta Odchudzająca jest idealna dla każdego, kto chce schudnąć, nie będąc przy tym aktywnym fizycznie. Najważniejszy jest tutaj odpowiedni dobór kalorii.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_3.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_9.jpg",
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dla osób chcących zredukować swoją masę ciała.
            <br /> <br />
            2. Dla osób zmagających się z chorobami cywilizacyjnymi: nadwaga,
            otyłość, cukrzyca, podwyższony cholesterol, choroby kardiologiczne.
            <br /> <br />
            3. Dla wszystkich chcących odżywiać się w sposób racjonalny.
            <br /> <br />
            4. Dla ludzi dbających o zdrowie i cieszących się życiem
          </span>
        ),
      },
    },
    ...
    cityDescription: {
      ...
      bielskoBiala: {
        description: [
          "Chcesz zrzucić zbędne kilogramy, ale nie przepadasz za treningami i aktywnością fizyczną? Dieta odchudzająca pozwoli Ci osiągnąć cel w bezpieczny sposób. Opiera się ona na ograniczeniu kaloryczności poszczególnych posiłków, przy jednoczesnym zagwarantowaniu odpowiedniej ilości składników odżywczych. ",
          "Menu jest odpowiednie dla osób, które mogą spożywać gluten i laktozę. Poszczególnie dania są bogate w nabiał i zawierają mniej węglowodanów. Po jedzeniu nie będziesz się czuł ociężały, a jednocześnie przestaniesz odczuwać napady głodu. ",
          "Jadłospis diety odchudzającej opiera się na chudym mięsie, warzywach, owocach, jajach, nasionach roślin strączkowych oraz na orzechach. Takie menu sprawi, że zyskasz wymarzoną figurę i zmienisz swoje nawyki żywieniowe. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-odchudzajaca">
              Dieta odchudzająca
            </a>{" "}
            pozwoli Ci zrzucić dodatkowe kilogramy, a jednocześnie sprawi, że
            poczujesz się lepiej i poprawi się Twoja kondycja. Co więcej,
            ustabilizuje ona poziom cukru we krwi.{" "}
          </span>,
        ],
      },
      gorzowWielkopolski: {
        description: [
          "Dieta odchudzająca jest odpowiednia dla osób, która chcą zrzucić nadprogramowe kilogramy, ale jednocześnie nie przepadają za aktywnością fizyczną. Od teraz, dzięki odpowiedniemu menu osiągniesz swój cel i to w całkowicie bezpieczny sposób. ",
          "Menu w diecie odchudzającej opiera się na ograniczeniu kalorycznym poszczególnych posiłków, przy jednoczesnym zapewnianiu organizmowi odpowiedniej ilości witamin, minerałów i mikroelementów. Będziesz się zdrowo odżywiał i poczujesz się lekko. Koniec z wilczym apetytem. Posiłki z takiego menu zaspokoją poczucie głodu. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-odchudzajaca">
              Dieta odchudzająca
            </a>{" "}
            zawiera posiłki z glutenem i laktozą. Jadłospis obfituje w chude
            mięso, warzywa, owoce, jaja, nasiona roślin strączkowych, orzechy.
            Menu zawiera mniejszą ilość węglowodanów.{" "}
          </span>,
          "Dzięki takim daniom, osiągniesz swój cel w postaci szczupłej sylwetki, ale jednocześnie odczujesz poprawę kondycji i wyrobisz odpowiednie nawyki żywieniowe. Na pewno szybko się przyzwyczaisz do lekkich, ale i sycących posiłków. ",
        ],
      },
      kutno: {
        description: [
          <span>
            ...
            jest przeznaczona dla osób, które chcą zrzucić dodatkowe kilogramy,
            ale nie przepadają za treningami. Taki jadłospis umożliwi Ci
            schudnięcie w bezpieczny i kontrolowany sposób.{" "}
          </span>,
          "Menu opiera się na zmniejszeniu ilości węglowodanów. W jadłospisie znajdziesz dania z chudego mięsa, warzyw, owoców, jaj, nasion roślin strączkowych, orzechów i nie tylko. Poszczególne posiłki zawierają nieco mniejszą ilość kalorii, aczkolwiek są one odpowiednio zbilansowane. ",
          "Dania zapewniają Ci właściwą ilość witamin, minerałów i mikroelementów. Dieta odchudzająca eliminuje napady głodu. Spożywając takie posiłki, będziesz najedzony, ale jednocześnie pełen energii do działania. ",
          "Jadając posiłki z diety odchudzającej, zaczniesz się zdrowo odżywiać. Należy podkreślić, że poszczególne dania zawierają gluten i laktozę, a więc menu jest nieodpowiednie dla osób borykających się z nietolerancjami pokarmowymi.  ",
        ],
      },
      opole: {
        description: [
          ...
          <span>
            ...
            sprawi, że pokochasz lekkie, zdrowe, ale i sycące posiłki, które
            dostarczają w odpowiednich ilościach witaminy, minerały i
            mikroelementy.{" "}
          </span>,
        ],
      },
      kielce: {
        description: [
          <span>
            Chcesz schudnąć, ale jednocześnie nie jesteś szczególnie aktywny
            fizycznie? Czujesz, że intensywne treningi to nie Twoja bajka?{" "}
            <a href="https://afterfit-catering.pl/dieta-odchudzajaca">
              Dieta odchudzająca
            </a>{" "}
            będzie dla Ciebie idealna. Od teraz możesz zrzucić zbędne kilogramy
            w bezpieczny sposób, przechodząc na odpowiedni jadłospis.{" "}
          </span>,
      ...
      plock: {
        description: [
          <span>
            Jeśli nie przepadasz za aktywnością fizyczną, ale jednocześnie
            zależy Ci na tym, by zrzucić zbędne kilogramy, to{" "}
            <a href="https://afterfit-catering.pl/dieta-odchudzajaca">
              dieta odchudzająca
            </a>{" "}
            będzie dla Ciebie idealna. Taki jadłospis pozwala schudnąć w
      ...
      radom: {
        description: [
          <span>
            ...
            jest dla Ciebie idealna, jeśli chcesz schudnąć, ale nie lubisz
            treningów i nie przepadasz za regularną aktywnością fizyczną.
            Rozsądny i zdrowy jadłospis pomoże Ci osiągnąć cel w całkowicie
            bezpieczny sposób.{" "}
          </span>,
      ...
      rzeszow: {
        description: [
          <span>
            ...
            pozwala zrzucić zbędne kilogramy nawet, jeśli nie przepadasz za
            treningami. Cały proces kształtowania figury i dochodzenia do
            upragnionego celu odbywa się w kontrolowany i całkowicie bezpieczny
            sposób.{" "}
          </span>,
      ...
      szczecin: {
        description: [
          ...
          <span>
            ...
            bazuje na produktach o ograniczonej kaloryczności, dzięki czemu
            będziesz chudnąć. Menu jest jednocześnie odpowiednio zbilansowane, a
            tym samym zawiera wszystkie niezbędne składniki odżywcze. Zdrowe
            dania będą różnorodne i każdego dnia będą Cię zaskakiwać smakiem.{" "}
          </span>,
      ...
      wloclawek: {
        description: [
          ...
          <span>
            ...
            umożliwi Ci zdrowe odżywianie się. Jadłospis zawiera gluten i
            laktozę, a więc jest nieodpowiedni dla osób borykających się z
      ...
      bialystok: {
        description: [
          <span>
            Chcesz bezpiecznie zrzucić zbędne kilogramy?{" "}
            <a href="https://afterfit-catering.pl/dieta-odchudzajaca">
              Dieta odchudzająca
            </a>{" "}
            będzie dla Ciebie idealna! Główne założenie jadłospisu dotyczy
            zmniejszenia dziennej dawki przyjmowanych kalorii, przy jednoczesnym
            dostarczaniu organizmowi wszystkich niezbędnych witamin, minerałów i
      ...
      czestochowa: {
        description: [
          <span>
            ...
            jest dla Ciebie idealna, jeśli chcesz zrzucić nadprogramowe
            kilogramy, ale jednocześnie nie przepadasz za aktywnością fizyczną.
            Od teraz napady głodu zostaną zredukowane, a Ty poczujesz się
            najedzony, ale nie przepełniony.{" "}
          </span>,
  ...
  },
  {
    ...
    dietId: 114,
    metaDescription:
      "Dieta Paleo bazuje na prostym, bezglutenowym menu. Jest ono bogate w białka i tłuszcze. Składa się głównie z dań mięsnych, ryb, jaj, owoców i warzyw.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dla sportowców oraz osób aktywnych fizycznie. <br /> <br />
            2. Osób chorujących na celiakię oraz wszystkich z nietolerancją
            glutenu <br /> <br />
            3. Dla osób nie tolerujących laktozy, i/ czy kazeiny <br />
            4. Osób chorych na Hashimoto <br /> <br />
            5. Osób z insulino opornością
          </span>
        ),
      },
    },
    ...
    offerDescription:
      "Dieta białkowo-tłuszczowa dla osób, które nie tolerują glutenu i roślin strączkowych",
    cityDescription: {
      lodz: {
        description: [
      ...
      bielskoBiala: {
        description: [
          "Chcesz całkowicie wyeliminować szkodliwe produkty ze swojego jadłospisu i bezpiecznie schudnąć? Dieta paleo na pewno spełni Twoje oczekiwania! Tzw. „menu człowieka paleolitu” bazuje wyłącznie na zdrowych składnikach. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            opiera się na warzywach, owocach, orzechach, grzybach, jajkach,
            mięsie i rybach, a więc na naturalnych składnikach. Jadłospis
            eliminuje całkowicie produkty przetworzone. Będzie on odpowiedni
            również dla osób uczulonych na gluten.{" "}
          </span>,
          "Dieta paleo jest wysokobiałkowa, a poszczególne dania zawierają małą ilość węglowodanów i większą tłuszczu. Jadłospis jest bogaty w żelazo hemowe, błonnik oraz kwasy tłuszczowe omega 3. Dzięki temu, organizmowi jest dostarczana energia.",
          "Od teraz wcielisz w życie zdrowe nawyki żywieniowe i zredukujesz swoją wagę. Dieta paleo podkreśla również rolę aktywności fizycznej. ",
        ],
      },
      gorzowWielkopolski: {
        description: [
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            jest odpowiednia dla osób, które chcą wyeliminować ze swojego menu
            przetworzone produkty i pragną się odżywiać zdrowo. Z takiego
            jadłospisu mogą skorzystać także osoby cierpiące na nietolerancję
            glutenu.{" "}
          </span>,
          "Tzw. jadłospis człowieka paleolitu bazuje wyłącznie na naturalnych składnikach. Znajdziemy w nim posiłki składające się z mięsa, ryb, jaj, warzyw, owoców, orzechów i pestek. Całe menu jest wysokobiałkowe i doda Ci energii.",
          "Posiłki z diety paleo są bogate w żelazo hemowe, błonnik oraz kwasy tłuszczowe omega 3. Ilość węglowodanów jest tu znacząco ograniczona. Z poszczególnych dań jest wyeliminowany gluten, produkty modyfikowane i sztuczne, produkty mleczne i zboża. ",
          "Takie menu pozwoli Ci wcielić w życie zdrowe nawyki jedzeniowe, a dodatkowo zredukować swoją wagę. Skutki tej diety szybko odczujesz: poczujesz się lepiej i będziesz miał więcej siły i energii do działania. ",
        ],
      },
      kutno: {
        description: [
          "Dieta paleo, czyli tzw. jadłospis człowieka pierwotnego, pozwoli Ci się odżywiać zdrowo i pozbyć się z codziennego menu wszystkich przetworzonych produktów, produktów mlecznych oraz glutenu. ",
          "Jadłospis opiera się na wyłącznie zdrowych daniach z naturalnych produktów. Znajdziesz w nim posiłki bazujące na mięsie, rybach, jajach, warzywach, owocach, orzechach i pestkach. Są one bogate w błonnik, żelazo hemowe, błonnik oraz kwasy tłuszczowe omega 3.",
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            jest dietą wysokobiałkową, która doda Ci energii. Węglowodany są
            tutaj ograniczone. Dzięki temu, będziesz mógł nieco zredukować wagę.
            Jednocześnie odstawienie wszystkich sztucznych składników wpłynie
            pozytywnie na Ciebie.
          </span>,
          "Dieta paleo sprawi, że odczujesz poprawę w zakresie kondycji, samopoczucia i stanu zdrowia. Proste dania z takiego menu są różnorodne i smaczne. Będziesz nimi zachwycony!",
        ],
      },
      kielce: {
        description: [
          <span>
            Chcesz przejść na prosty jadłospis, z którego wyeliminowana zostanie
            sztuczna żywność?{" "}
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>,
            czyli tzw. jadłospis człowieka paleolitu idealnie wpisze się w Twoje
            potrzeby. Od teraz będziesz jadał wyłącznie zdrowe dania opierające
            się na naturalnych produktach.{" "}
          </span>,
      ...
      opole: {
        description: [
          ...
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            pozwala na wyeliminowanie wszystkich potencjalnie szkodliwych
            składników z Twojego codziennego jadłospisu. Pozytywne skutki
            działania takiego menu odczujesz bardzo szybko.{" "}
          </span>,
        ],
      },
      plock: {
        description: [
          ...
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            jest wysokobiałkowa, a dania zawierają małą ilość węglowodanów i
            większą tłuszczu. Wpłynie to na Twoją kondycję, samopoczucie oraz
            stan zdrowia. Odstawienie żywności zmodyfikowanej to pierwszy krok
            do możliwie najlepszego sposobu odżywiania się.{" "}
          </span>,
      ...
      radom: {
        description: [
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            budzi coraz większe zainteresowanie, co wynika z faktu, że eliminuje
            ona wszystkie sztuczne i przetworzone produkty i bazuje wyłącznie na
            naturalnych i zdrowych składnikach. Jeśli zatem i Ty chcesz przestać
            jadać to, co przetworzone, to ta dieta będzie dla Ciebie idealna.{" "}
          </span>,
      ...
      rzeszow: {
        description: [
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>,
            zwana również „jadłospisem człowieka paleolitu” opiera się na
            zdrowych, naturalnych i nieprzetworzonych produktach. Odrzuca ona
            wszystkie sztuczne i zmodyfikowane składniki. Pozwala ona wcielić w
            życie zdrowe nawyki jedzeniowe.{" "}
          </span>,
      ...
      wloclawek: {
        description: [
          ...
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            jest wysokobiałkowa i dodaje Ci energii. Z racji ograniczenia
            węglowodanów, będziesz mógł zredukować wagę. Odstawienie wszystkich
            zmodyfikowanych składników wpłynie pozytywnie na stan zdrowia i
            samopoczucie.{" "}
          </span>,
      ...
      szczecin: {
        description: [
          ...
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            wpłynie na Twój stan zdrowia, samopoczucie, ale i na przyzwyczajenia
            jedzeniowe. Od teraz będziesz sięgał jedynie po to, co naturalne i
            nieprzetworzone. Wpłynie to pozytywnie na Twój stan zdrowia i
            samopoczucie.{" "}
          </span>,
        ],
      },
      czestochowa: {
        description: [
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            to wysokobiałkowe menu o sporej zawartości tłuszczu. Jadłospis
            całkowicie eliminuje żywność przetworzoną, gluten, produkty mleczne
            oraz sztuczne składniki. Jeśli borykasz się z alergiami pokarmowymi,
            to menu jest równie dla Ciebie odpowiednie.{" "}
          </span>,
      ...
      bialystok: {
        description: [
          <span>
            <a href="https://afterfit-catering.pl/dieta-paleo">Dieta Paleo</a>{" "}
            pozwala dostarczyć organizmowi dużo energii i pozwala bezpiecznie
            schudnąć. Menu uwzględnia składniki, do których przypuszczalnie miał
            dostęp człowiek już w okresie paleolitu. Według badań, każdy z nas
            jest niemalże przystosowany genetycznie do takiego sposobu odżywania
            się.{" "}
          </span>,
  ...
  },
  {
    ...
    dietId: 134,
    metaDescription:
      "Dieta Samuraja kładzie nacisk na zdrowe odżywianie, wykluczając gluten i laktozę. Menu jest odpowiednie dla osób aktywnych fizycznie.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dieta Samuraja jest przeznaczona dla ludzi aktywnych fizycznie o
            podwyższonym wskaźniku zużycia energii, którzy posiłki węglowodanowe
            włączają do swojego jadłospisu przed i po treningu. <br /> <br />
            2. Osób chorujących na celiakię oraz wszystkich z nietolerancją
            glutenu. <br /> <br />
            3. Dla osób nie tolerujących laktozy, i/ czy kazeiny. <br /> <br />
            4. Osób obciążonych chorobami metabolicznymi i autoimmunologicznymi.
          </span>
        ),
      },
    },
    menu: {
      ...
      dinner:
        "Nuggetsy z kurczaka w płatkach kukurydzianych z pieczonymi ziemniakami i surówką z kapusty pekińskiej",
      tea: "Zupa meksykańska",
      supper:
        "Pikantny dorsz po tajsku z warzywami z ryżem brązowym długo-ziarnistym",
    },
    offerDescription:
      "Dieta dla osób aktywnych, które nie tolerują glutenu i kazeiny",
    cityDescription: {
      lodz: {
        description: [
      ...
      gorzowWielkopolski: {
        description: [
          "Dieta samuraja jest dedykowana osobom aktywnym fizycznie i tym, którzy intensywnie trenują. Samo menu nawiązuje do sposobu odżywiania japońskich wojowników!",
          "Jadłospis czerpie inspiracje z diety paleo oraz z diety sportowej na masę. Menu zawiera większą ilość węglowodanów niż paleo, a jednocześnie spełni oczekiwania wszystkich osób, które uwielbiają dania mięsne. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-samuraja">
              Dieta samuraja
            </a>{" "}
            eliminuje produkty przetworzone, gluten i laktozę, więc jeśli
            cierpisz na nietolerancje pokarmowe, to możesz z powodzeniem z niej
            skorzystać. W jadłospisie znajdziemy naturalne składniki, takie jak
            warzywa, owoce, mięso, ryby, jaja, oliwa, bezglutenowe zboża.{" "}
          </span>,
          "Poszczególne posiłki składają się pełnowartościowych składników odżywczych, dzięki czemu będziesz jadał wszystko to, co najlepsze. Dania z diety samuraja zaskoczą Cię różnorodnością oraz ciekawym smakiem.",
        ],
      },
      bielskoBiala: {
        description: [
          <span>
            Jesteś aktywny fizycznie, uwielbiasz treningi i szukasz
            odpowiedniego menu dla siebie?{" "}
            <a href="https://afterfit-catering.pl/dieta-samuraja">
              Dieta samuraja
            </a>{" "}
            na pewno spełni Twoje oczekiwania! Wypróbuj jadłospis nawiązujący do
            sposobu odżywiania japońskich wojowników!
          </span>,
          "W menu możemy znaleźć nawiązania do diety paleo oraz sportowej na masę. Poszczególne posiłki zawiera większą ilość węglowodanów aniżeli w paleo. Podstawą jadłospisu są naturalne produkty, a więc warzywa, owoce, mięso, ryby, jaja, oliwa, bezglutenowe zboża. Żywność przetworzona, gluten i laktoza są wyeliminowane. ",
          "Dietę samuraja docenią zwłaszcza osoby, które przepadają za mięsem. Poszczególne posiłki zawierają pełnowartościowe składniki odżywcze, a dania są niezwykle urozmaicone więc nieraz Cię zaskoczą. ",
          "Takie menu pozwala na wymodelowanie sylwetki i na wcielenie w życie zdrowych nawyków. Nawet jeśli cierpisz na alergie pokarmowe, to możesz dostarczać organizmowi wszystko to, co najlepsze!",
        ],
      },
      kielce: {
        description: [
          <span>
            Twoje życie to aktywność fizyczna i treningi? Nie wyobrażasz sobie
            bez tego dnia?{" "}
            <a href="https://afterfit-catering.pl/dieta-samuraja">
              Dieta samuraja
            </a>{" "}
            idealnie wpisze się w Twoje potrzeby. Łączy ona w sobie dietę paleo
            oraz dietę sportową na masę.{" "}
          </span>,
      ...
      kutno: {
        description: [
          <span>
            ...
            jest idealną dietą dla osób regularnie ćwiczących, które nie
            wyobrażają sobie dnia bez aktywności fizycznej i chcą się
            odpowiednio odżywiać. Takie menu pozwala jeszcze bardziej wyrzeźbić
            sylwetkę.{" "}
          </span>,
          "Menu zawiera w sobie elementy diety paleo oraz sportowej na masę. Znajdziemy tu więcej węglowodanów aniżeli w paleo. Jadłospis przypadnie do gustu zwłaszcza tym osobom, które uwielbiają mięso. ",
          "Jadłospis diety samuraja składa się z warzyw, owoców, mięsa, ryb, jaj, oliwy i z bezglutenowych zbóż. Wszystko jest odpowiednio skomponowane, aby zaspokoić Twój dzienny bilans energetyczny i sprawić, by był najedzony.  ",
          "Dieta samuraja eliminuje gluten i laktozę, a zatem nawet jeśli cierpisz na nietolerancje pokarmowe, to możesz na nią przejść. Menu jest urozmaicone, a poszczególne dania niezwykle smaczne. ",
        ],
      },
      opole: {
        description: [
          ...
          <span>
            ...
            przypadnie do gustu zwłaszcza tym osobom, które uwielbiają mięso. W
            menu znajdziemy warzywa, owoce, mięso, ryby, jaja, oliwa,
            bezglutenowe zboża.{" "}
          </span>,
      ...
      plock: {
        description: [
          <span>
            Jeśli uwielbiasz wysiłek fizyczny, intensywnie trenujesz i szukasz
            odpowiedniego menu, to{" "}
            <a href="https://afterfit-catering.pl/dieta-samuraja">
              dieta samuraja
            </a>{" "}
            będzie dla Ciebie odpowiednia. Stanowi ona połączenie diety paleo i
            sportowej na masę.{" "}
          </span>,
      ...
      radom: {
        description: [
          ...
          <span>
            ...
            czerpie z diety paleo oraz z diety sportowej na masę. W odróżnieniu
            od paleo, jadłospis zawiera większą ilość węglowodanów. W skład menu
            wchodzi sporo dań mięsnych.{" "}
          </span>,
      ...
      rzeszow: {
        description: [
          ...
          <span>
            ...
            eliminuje produkty przetworzone, gluten oraz laktozę. Wpłynie to
            pozytywnie na Twój stan zdrowia i samopoczucie.{" "}
          </span>,
      ...
      wloclawek: {
        description: [
          ...
          <span>
            ...
            jest odpowiednia także dla tych, którzy cierpią na nietolerancje
            pokarmowe. Nawet przy tego rodzaju przypadłościach można się
            odpowiednio odżywiać, będąc przy tym aktywnym fizycznie.{" "}
          </span>,
        ],
      },
      szczecin: {
        description: [
          ...
          <span>
            ...
            łączy w sobie elementy diety paleo i sportowej na masę. Poszczególne
            posiłki zawierają dużą ilość węglowodanów, a zatem dodadzą Ci
            energii.{" "}
          </span>,
      ...
      czestochowa: {
        description: [
          <span>
            ...
            to połączenie diety paleo i diety sportowej na masę. Jeśli lubisz
            ruch, aktywność fizyczną i regularnie trenujesz, to będzie ona dla
            Ciebie idealna. Menu zostało tak skomponowane, żeby trafiać również
            w potrzeby osób cierpiących na nietolerancje pokarmowe. Jest ono
            pozbawione glutenu i laktozy.{" "}
          </span>,
      ...
      bialystok: {
        description: [
          ...
          <span>
            ...
            jest wysokobiałkowa. Poszczególne posiłki zawierają większą ilość
            węglowodanów aniżeli dieta paleo. Jej podstawę stanowią naturalne
            produkty, a więc warzywa, owoce, mięso, ryby, jaja, oliwa,
            bezglutenowe zboża. Menu eliminuje żywność przetworzoną, gluten i
            laktozę.{" "}
          </span>,
  ...
  // },
  {
    ...
    dietId: 104,
    metaDescription:
      "Dieta sportowa na masę jest dietą wysokobiałkową, dzięki czemu nie dochodzi do „spalania mięśni”. Ciesz się lepszą kondycją oraz dobrym samopoczuciem.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_3.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_14.jpg",
    ...
    questions: {
      ...
      2: {
        question: "Dla kogo?",
        answer:
          "Dieta skierowana do osób, które w miarę aktywnie uprawiają sport i pragną zredukować tkankę tłuszczową, a nie maja czasu ani wiedzy potrzebnej do przygotowania odpowiednio zbilansowanych posiłków.",
      },
    },
    menu: {
      breakfast: "Sałatka Cesar z grzanką z bagietki",
      secondBreakfast: "Koktajl z awokado i masłem orzechowym",
      dinner:
        "Pierś z kurczaka grillowana w ziołach, ryż brązowy z warzywami na parze",
      tea: "Sałatka z pieczoną dynia, szpinakiem, suszonymi pomidorami i fetą.",
      supper: "Naleśniki owsiane z białym serem, miodem i orzechami.",
    },
    offerDescription:
      "Dieta dla osób aktywnych chcących zredukować tkankę tłuszczową",
    cityDescription: {
      lodz: {
        description: [
      ...
      bielskoBiala: {
        description: [
          <span>
            Chcesz zgubić zbędne kilogramy i spalić nadmiar tkanki tłuszczowej,
            a jednocześnie jesteś aktywny fizycznie?{" "}
            <a href="https://afterfit-catering.pl/dieta-sportowa-na-redukcje">
              Dieta sportowa
            </a>{" "}
            na redukcję będzie dla Ciebie idealna! Odpowiednio zbilansowane
            posiłki dostarczą Ci wszystkich niezbędnych składników.
          </span>,
          "Jadłospis w przypadku diety na redukcję zawiera sporą ilość białka i mniej węglowodanów oraz tłuszczów. Więcej białka napędza metabolizm, ale i chroni przez tzw. „spalaniem” mięśni. Pozbędziesz się tkanki tłuszczowej, ale Twoje mięśnie dalej będą odpowiednio wyglądać. ",
          "Podstawą jadłospisu diety sportowej na redukcję są warzywa, nabiał o niskiej zawartości tłuszczu, ryby, chude mięso drobiowe oraz owoce.",
          "Sama redukcja tkanki tłuszczowej jest procesem, który może trwać sporo czasu. Dieta sportowa na redukcję musi iść w parze z odpowiednim treningiem. Kluczowe jest tutaj trzymanie się odpowiedniego zapotrzebowania kalorycznego.",
        ],
      },
      gorzowWielkopolski: {
        description: [
          <span>
            ...
            na redukcję jest przeznaczona dla wszystkich osób aktywnych
            fizycznie, które chcą zrzucić dodatkowe kilogramy, a jednocześnie
            ochronić mięśnie przed tzw. spalaniem.{" "}
          </span>,
          "Menu jest wysokobiałkowe, co napędza metabolizm. Opiera się ono również na mniejszej ilości węglowodanów oraz tłuszczów. Wszystko to przyczyni się do redukcji tkanki tłuszczowej. Całość jest perfekcyjnie zbilansowana, by dostarczyć Tobie wszystko to, co niezbędne. ",
          "Dietę sportową na redukcję należy połączyć z odpowiednim planem treningowym. Wówczas da ona odpowiednie efekty w postaci wyrzeźbionej sylwetki oraz redukcji tkanki tłuszczowej. Sama redukcja tkanki tłuszczowej jest procesem rozciągniętym w czasie.",
          "W przypadku tego sposobu odżywiania, kluczowe jest tutaj trzymanie się odpowiedniego zapotrzebowania kalorycznego.",
        ],
      },
      kutno: {
        description: [
          <span>
            ...
            jest idealna dla wszystkich, którzy są aktywni fizycznie i chcą się
            zdrowo odżywiać, pozbyć tkanki tłuszczowej, ale bez szkody dla
            mięśni.{" "}
          </span>,
          "W menu znajdziemy dużą ilość białka, za to mniej węglowodanów oraz tłuszczów. Pozwoli to schudnąć, gdyż poprawia metabolizm. Warto dodać, że takie posiłki wpływają na spalanie tkanki tłuszczowej, ale jednocześnie chronią mięśnie. ",
          "W diecie sportowej na redukcję kluczowe jest trzymanie się odpowiedniego zapotrzebowania kalorycznego. Poszczególne posiłki są zdrowe i smaczne. Dostarczają one wszystkie niezbędne składniki odżywcze.",
          "Taki sposób odżywiania w połączeniu z odpowiednim planem treningowym na pewno pozwoli Ci osiągnąć wymarzony cel. Pamiętaj jednak, że proces spalania tkanki tłuszczowej jest rozłożony w czasie. ",
        ],
      },
      kielce: {
        description: [
          ...
          <span>
            ...
            na redukcję powinna być połączona z profesjonalnym planem
            treningowym. Tylko wówczas cel będzie łatwy do osiągnięcia. Należy
            podkreślić, że pozbycie się tkanki tłuszczowej to proces
            długotrwały.{" "}
          </span>,
        ],
      },
      opole: {
        description: [
          <span>
            ...
            jest odpowiednia dla osób aktywnych fizycznie, które chcą zrzucić
            dodatkowe kilogramy i pozbyć się nadmiaru tkanki tłuszczowej. W
            przypadku takiego sposobu odżywiania podkreślone jest to, by
            zabezpieczyć mięśnie przed „spalaniem”.
          </span>,
      ...
      plock: {
        description: [
          ...
          <span>
            ...
            na redukcję powinna iść w parze z odpowiednim planem treningowym -
            tylko wówczas da pożądane efekty. Pamiętaj, że redukcja tkanki
            tłuszczowej jest procesem długotrwałym.{" "}
          </span>,
        ],
      },
      radom: {
        description: [
          <span>
            ...
            cieszy się ogromną popularnością wśród osób, które są aktywne
            fizycznie i chcą się pozbyć nadmiaru tkanki tłuszczowej. Jeśli i Ty
            stawiasz sobie za cel odpowiednie wymodelowanie sylwetki, to
            będziesz zadowolony z takiego menu.{" "}
          </span>,
      ...
      wloclawek: {
        description: [
          ...
          <span>
            ...
            powinna być połączona z treningami, gdyż tylko wówczas da one
            oczekiwane rezultaty. Pamiętaj, że spalanie tkanki tłuszczowej to
      ...
      rzeszow: {
        description: [
          <span>
            ...
            na redukcję jest dedykowana aktywnym osobom, które chcą pozbyć się
            dodatkowych kilogramów i tkanki tłuszczowej, ale jednocześnie
            wiedzą, jak istotna jest tutaj ochrona mięśni.{" "}
          </span>,
      ...
      szczecin: {
        description: [
          <span>
            ...
            jest przeznaczona dla wszystkich tych, którzy chcą się pozbyć tkanki
            tłuszczowej i dodatkowych kilogramów. Specjalnie skomponowane menu
            pozwala jednocześnie chronić mięśnie.{" "}
          </span>,
      ...
      czestochowa: {
        description: [
          <span>
            ...
            na redukcję będzie dla Ciebie idealna, jeśli chcesz spalić nadmiar
            tkanki tłuszczowej, ale jednocześnie ochronić mięśnie. Takie menu
            nie musi być obciążające dla organizmu oraz dla psychiki.{" "}
          </span>,
      ...
      bialystok: {
        description: [
          <span>
            Chcesz zgubić zbędne kilogramy i w końcu spalić nadmiar tkanki
            tłuszczowej?{" "}
            <a href="https://afterfit-catering.pl/dieta-sportowa-na-redukcje">
              Dieta sportowa na redukcję
            </a>{" "}
            będzie dla Ciebie idealna! Bazuje ona na odpowiednio zbilansowanych
            posiłkach i zdrowych składnikach.{" "}
          </span>,
  ...
  },
  {
    ...
    dietId: 578,
    metaDescription:
      "Dieta standard pozwoli Ci zacząć się smacznie i zdrowo odżywiać. Menu dostarcza organizmowi niezbędne składniki odżywcze, witaminy i mikroelementy.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_10.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_9.jpg",
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dla osób chcących się zdrowo odżywiać. <br />
            <br />
            2. Dla osób, które nie mają czasu gotować, a chciałyby pokryć
            zapotrzebowanie organizmu na wszytskie składniki odżywcze.
          </span>
        ),
      },
    },
    ...
    cityDescription: {
      ...
      bielskoBiala: {
        description: [
          <span>
            Chcesz się zdrowo odżywiać, ale nie masz czasu na gotowanie?{" "}
            <a href="https://afterfit-catering.pl/dieta-standard">
              Dieta standard
            </a>{" "}
            jest tym, czego szukasz. Pozwoli Ci ona wyrobić zdrowe nawyki
            żywieniowe, utrzymać aktualną wagę lub delikatnie ją skorygować. W
            końcu zaczniesz się odpowiednio odżywiać!{" "}
          </span>,
          "Jadłospis eliminuje przetworzone i sztuczne produkty. Poszczególne dania są odpowiednio zbilansowane, a tym samym będziesz dostarczał organizmowi niezbędną ilość witamin i mikroelementów. Menu bazuje na pełnowartościowych składnikach!",
          "Takie posiłki sprawią, że odczujesz poprawę swojego stanu zdrowia, kondycji i samopoczucia. Już nie musisz liczyć kalorii i pilnować swojej wagi. ",
          "Od teraz właściwe odżywianie się będzie proste, a poszczególne dania smaczne i zdrowe. Dostarczaj organizmowi to, co najlepsze!",
        ],
      },
      kielce: {
        description: [
          ...
          <span>
            ...
            sprawi, że zaczniesz jeść dania składające się z najlepszych i
            starannie wyselekcjonowanych składników. W końcu przestawisz się na
            zdrowe odżywianie.{" "}
          </span>,
        ],
      },
      gorzowWielkopolski: {
        description: [
          "Dieta standard jest idealna dla wszystkich osób, które chcą się zdrowo odżywiać, ale nie mają czasu na gotowanie oraz na liczenie kalorii. Jadłospis sprawi, że będziesz na co dzień jadał wyłącznie to, co powinieneś, a dodatkowo delikatnie skorygujesz swoją wagę, co pozwoli Ci utrzymać nienaganną figurę. ",
          "Menu jest tak skonstruowane, by pomóc Ci wyrobić odpowiednie nawyki jedzeniowe. Wszystkie sztuczne produkty zostały wyeliminowane i zastąpione pełnowartościowymi. Poszczególne dania są nie tylko zdrowe, ale i smaczne. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-standard">
              Dieta standard
            </a>{" "}
            jest tak zbilansowana, by dostarczać Ci każdego dnia niezbędną ilość
            witamin i mikroelementów. Już nie musisz się zastanawiać, czy na
            pewno wszystko robisz prawidłowo.{" "}
          </span>,
          "Taki jadłospis pokazuje, jak proste jest utrzymanie dotychczasowej wagi. Zdrowe dania sprawią, że odczujesz poprawę swojego stanu zdrowia, kondycji, ale również samopoczucia. Zacznij jeść odpowiednio!",
        ],
      },
      kutno: {
        description: [
          <span>
            ...
            będzie dla Ciebie idealna, jeśli chcesz się zacząć zdrowo odżywiać,
            ale jednocześnie nie masz ochoty lub czasu na to, by samodzielnie
            gotować i pilnować się, jeśli chodzi o kalorie.{" "}
          </span>,
          "Menu pozwoli Ci utrzymać dotychczasową wagę lub delikatnie ją skorygować. Mało tego, zaczniesz jadać naprawdę zdrowo, dzięki czemu poczujesz się lepiej i jednocześnie poprawi się Twoja kondycja. ",
          "Jadłospis diety standard jest urozmaicony i lekki. Dba on o to, by dostarczać organizmowi niezbędne składniki odżywcze, witaminy i minerały. Co ważne, eliminuje on wszystkie szkodliwe składniki, a zatem pomoże Ci wcielić w życie zasady zdrowego odżywiania. ",
          "Od teraz będziesz jadał posiłki skomponowane ze starannie wybranych składników, które przysłużą się Twojemu lepszemu samopoczuciu.",
        ],
      },
      opole: {
        description: [
          <span>
            ...
            jest odpowiednia dla osób, które chcą się zdrowo odżywiać i
            wyeliminować potencjalnie szkodliwe składniki ze swojego codziennego
            menu. Taki sposób odżywiania pozwoli Ci delikatnie skorygować Twoją
            wagę.{" "}
          </span>,
      ...
      plock: {
        description: [
          ...
          <span>
            ...
            eliminuje przetworzone i sztuczne produkty. Menu jest właściwie
            zbilansowane - zawiera odpowiednią ilość witamin, składników
      ...
      wloclawek: {
        description: [
          <span>
            ...
            to idealna opcja dla osób, którym zależy na tym, by wcielić w życie
            zasady zdrowego odżywiania. Menu eliminuje szkodliwe i sztuczne
            produkty, a ponadto daje pewność, że przyjmujesz odpowiednią ilość
            kalorii.{" "}
          </span>,
      ...
      radom: {
        description: [
          ...
          <span>
            ...
            pozwala utrzymać obecną wagę ciała lub też nieznacznie ją
            skorygować. Poszczególne posiłki są lekkie, ale i sycące. Na pewno
            nie będziesz po nich głodny. Dania zachwycą Cię smakiem i
            różnorodnością.{" "}
          </span>,
      ...
      rzeszow: {
        description: [
          ...
          <span>
            ...
            pozwala delikatnie skorygować wagę. Jadłospis obejmuje dania
            składające się z nieprzetworzonych produktów. Lekkie menu zachwyci
            Cię smakiem. Każdego dnia będziesz jadał urozmaicone posiłki, po
            których poczujesz się lekko.{" "}
          </span>,
      ...
      szczecin: {
        description: [
          ...
          <span>
            ...
            sprawi, że wykluczysz ze swojego menu wszystko to, co niezdrowe.
            Różnicę w samopoczuciu i kondycji odczujesz bardzo szybko.{" "}
          </span>,
        ],
      },
      czestochowa: {
        description: [
          ...
          <span>
            ...
            pozwala na utrzymanie obecnej masy ciała lub na jej delikatne
            skorygowanie. Pomoże ona wyeliminować niewłaściwe i przetworzone
            produkty z codziennego jadłospisu.{" "}
          </span>,
      ...
      bialystok: {
        description: [
          <span>
            Jeśli chcesz zadbać o sposób odżywiania się i wyrobić zdrowe nawyki
            żywieniowe, to{" "}
            <a href="https://afterfit-catering.pl/dieta-standard">
              dieta standard
            </a>{" "}
            będzie dla Ciebie odpowiednia. Pozwala ona na bezproblemowe
            utrzymanie aktualnej masy ciała lub delikatne jej skorygowanie przy
            jednoczesnym wyeliminowaniu niewłaściwych produktów i zwyczajów.{" "}
          </span>,
  ...
  },
  {
    ...
    dietId: 577,
    metaDescription:
      "Dieta wegańska zmniejsza ryzyko wystąpienia otyłości, nadciśnienia, cukrzycy i niektórych nowotworów. Eliminuje ona całkowicie produkty odzwierzęce.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      ...
      2: {
        ...
        answer: (
          <span>
            ...
            <br />
            <br />
            3. Dla osób, które chcą się żywić najwyższej jakości produktami
            roślinnymi.
          </span>
        ),
      },
    ...
    menu: {
      breakfast:
        "Tofucznica z grzankami posmarowanymi oliwą czosnkową i pomidorkami koktajlowymi.",
      secondBreakfast: "Krem z kaszy jaglanej z kakao, daktylami i bananami.",
      dinner:
        "Fajitas z tofu ,papryką i czerwoną cebulą podane z guacamole i grillowanymi tortillami.",
      tea:
        "Sałatka z pieczonym batatem, rukolą, wegańskim serem i granatem polana pikantnym malinowym sosem.",
      supper:
        "Pulpety z ciecierzycy z sosem żurawinowym, puree z zielonego groszku i kapustą modro po koreańsku.",
    },
    offerDescription:
      "Dieta oparta o najwyższej jakości produkty pochodzenia roślinnego",
    cityDescription: {
      lodz: {
        description: [
      ...
      gorzowWielkopolski: {
        description: [
          <span>
            <a href="https://afterfit-catering.pl/dieta-weganska">
              Dieta wegańska
            </a>{" "}
            jest odpowiednia dla osób zdeterminowanych, by całkowicie zmienić
            swoje nawyki żywieniowe i na dobre wyeliminować ze swojego
            jadłospisu mięso i produkty odzwierzęce. Warto dodać, że takie menu
            jest całkowicie bezpieczne i zdrowe dla Twojego organizmu.{" "}
          </span>,
          "W skład menu wchodzą pełnowartościowe posiłki bazujące na produktach roślinnych. W jadłospisie można znaleźć rośliny, owoce, kasze, orzechy, nasiona, algi morskie. Poszczególne dania są niezwykle różnorodne, syte i smaczne. ",
          "W diecie wegańskiej niezbędne składniki odżywcze są pozyskiwane z produktów roślinnych (np. wapń z mleka sojowego, białko z orzechów itd.). Istotne jest, by dodatkowo suplementować witaminy D oraz B12. ",
          "Przejście na weganizm zmniejsza ryzyko zachorowania na otyłość, nadciśnienie, cukrzycę, nowotwory i kamicę żółciową.",
        ],
      },
      bielskoBiala: {
        description: [
          <span>
            Chcesz zrezygnować z mięsa i produktów odzwierzęcych?{" "}
            <a href="https://afterfit-catering.pl/dieta-weganska">
              Dieta wegańska
            </a>{" "}
            będzie dla Ciebie idealna! Taki jadłospis będzie rewolucją w Twoim
            życiu, ale cały proces jest całkowicie bezpieczny!
          </span>,
          "Menu opiera się na roślinach, zbożach, orzechach, nasionach i algach morskich. Ciekawe połączenia składników są oryginalne i zaskakują wyjątkowym i zarazem pysznym smakiem. Posiłki przygotowane z produktów roślinnych są pełnowartościowe. ",
          "Składniki odżywcze w diecie wegańskiej są pozyskiwane z produktów roślinnych (np. wapń z mleka sojowego, roślin strączkowych i niektórych warzyw; białko z orzechów, soi, soczewicy i bobu). Menu zmniejsza ryzyko zachorowania na otyłość, nadciśnienie, cukrzycę, nowotwory i kamicę żółciową.",
          "Jadłospis wymaga dodatkowej suplementacji witaminy D oraz B12 ze względu na ograniczone możliwości pozyskiwania ich z produktów roślinnych. ",
        ],
      },
      kutno: {
        description: [
          "Dieta wegańska całkowicie eliminuje mięso i produkty odzwierzęce. Jest ono odpowiednie dla tych, którzy chcą radykalnie zmienić swoje przyzwyczajenia, ale jednocześnie ważna jest dla nich pewność, że dostarczają organizmowi wszystkie niezbędne składniki odżywcze. ",
          "Menu jest urozmaicone i czerpie z bogactwa produktów roślinnych. Znajdziesz tu dania składające się z różnorodnych roślin, owoców, kasz, nasion, orzechów i alg morskich. Ciekawe połączenia będą naprawdę smaczne. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-weganska">
              Dieta wegańska
            </a>{" "}
            jest całkowicie bezpieczna i zdrowa. Składniki odżywcze są
            pozyskiwane z produktów roślinnych (np. wapń z mleka sojowego,
            białko z orzechów itd.). Istotna jest tutaj dodatkowa suplementacja
            witaminy D oraz B12 (ciężko się je uzupełnia z produktów
            roślinnych).{" "}
          </span>,
          "Weganizm minimalizuje ryzyko zachorowania na otyłość, nadciśnienie, cukrzycę, nowotwory i kamicę żółciową.",
        ],
      },
      kielce: {
        description: [
          <span>
            Jesteś zdeterminowany, by całkowicie wyeliminować ze swojego menu
            mięso i produkty odzwierzęce?{" "}
            <a href="https://afterfit-catering.pl/dieta-weganska">
              Dieta wegańska
            </a>{" "}
            będzie dla Ciebie odpowiednia! Menu jest całkowicie bezpieczne dla
            Twojego organizmu i dostarcza do niego wszystko to, co niezbędne i
            najlepsze.
          </span>,
      ...
      opole: {
        description: [
          <span>
            ...
            jest odpowiednia dla osób, które chcą odstawić mięso i produkty
            odzwierzęce. Należy przy tym podkreślić, że jest ona całkowicie
            bezpieczna i odpowiednia dla Twojego organizmu. Bardzo szybko
            odczujesz różnicę w codziennym funkcjonowaniu i samopoczuciu.{" "}
          </span>,
      ...
      plock: {
        description: [
          <span>
            Jeśli chcesz zrezygnować z mięsa i produktów odzwierzęcych, to{" "}
            <a href="https://afterfit-catering.pl/dieta-weganska">
              dieta wegańska
            </a>{" "}
            jest dokładnie tym, czego szukasz. Zmiana nawyków jedzeniowych jest
            tutaj konkretna, ale sprawi ona, że poczujesz się dużo lepiej.{" "}
          </span>,
      ...
      radom: {
        description: [
          ...
          <span>
            ...
            jest całkowicie bezpieczna. Zmniejsza ona ryzyko zachorowania na
            otyłość, nadciśnienie, cukrzycę, nowotwory i kamicę żółciową.
            Istotne jest to, by przy takim menu, dodatkowo suplementować
            witaminy D i B12.{" "}
          </span>,
        ],
      },
      szczecin: {
        description: [
          <span>
            ...
            jest idealna dla wszystkich tych, którzy całkowicie wykluczyli lub
            chcą wykluczyć produkty odzwierzęce i mięso. Taki jadłospis jest
            zdrowy i bezpieczny i udowadnia, że dania opierające się na
            różnorodności produktów roślinnych zaskakują pysznym smakiem.{" "}
          </span>,
      ...
      wloclawek: {
        description: [
          ...
          <span>
            ...
            wpływa pozytywnie na samopoczucie i stan zdrowia, a przy tym
            minimalizuje ryzyko zachorowania na otyłość, nadciśnienie, cukrzycę,
            nowotwory i kamicę żółciową.
          </span>,
        ],
      },
      rzeszow: {
        description: [
          <span>
            ...
            zakłada całkowitą rezygnację z mięsa i wszystkich produktów
            odzwierzęcych. Menu opiera się na różnorodności roślin, zbóż,
            orzechów, nasion i alg morskich. Należy tu podkreślić, że jest ono
            całkowicie bezpieczne i odpowiednio zbilansowane.{" "}
          </span>,
      ...
      czestochowa: {
        description: [
          <span>
            ...
            eliminuje mięso i produkty odzwierzęce. Jeśli chcesz całkowicie
            zmienić swoje zwyczaje jedzeniowe, to będzie ona dla Ciebie
            odpowiednia. Poszczególne posiłki nieraz Cię zaskoczą swoją
            różnorodnością oraz niesamowitym smakiem.{" "}
          </span>,
      ...
      bialystok: {
        description: [
          <span>
            ...
            jest odpowiednia dla osób, które chcą zrezygnować z mięsa i
            produktów odzwierzęcych. Zmiana nawyków jedzeniowych jest w tym
            przypadku konkretna, ale przy odpowiednim menu całkowicie
            bezpieczna.{" "}
          </span>,
  ...
  },
  {
    ...
    dietId: 576,
    metaDescription:
      "Dieta wegetariańska bazuje na warzywach, owocach, roślinach, kaszach i nasionach. Mimo wyeliminowania mięsa, posiłki są smaczne, sycące i zróżnicowane.",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_13.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_11.jpg",
      ...
      2: {
        ...
        answer: (
          <span>
            ...
            <br />
            2. Dla osób, które nie mają czasu gotować, a chciałyby pokryć
            zapotrzebowanie organizmu na wszytskie składniki odżywcze. <br />
            <br />
            3. Dla osób, które chcą się żywić produktami roślinnymi ale
            dopuszczają spożycie takich składników jak jajka czy nabiał.
          </span>
        ),
      },
    },
    menu: {
      ...
      dinner:
        "Fajitas z tofu, papryką i czerwoną cebulą podane z guacamole i grillowanymi tortillami.",
      tea:
        "Sałatka z pieczonym batatem, rukolą, kozim serem i granatem polana pikantnym malinowym sosem.",
      supper:
        "Pulpety z ciecierzycy z sosem żurawinowym, puree z zielonego groszku i kapustą modro po koreańsku.",
    },
    offerDescription:
      "Dieta roślinna dopuszczająca spożywanie takich pokarmów jak jajka i nabiał",
    cityDescription: {
      lodz: {
        description: [
      ...
      bielskoBiala: {
        description: [
          "Już od dawna zastanawiałeś się nad odstawieniem mięsa i w końcu się zdecydowałeś? Słuszny wybór! Dieta wegetariańska wpłynie pozytywnie na Twoją sylwetkę, stan zdrowia, kondycję organizmu i samopoczucie! Mało tego, pozwoli ona ograniczyć ryzyko chorób serca, cukrzycy, otyłości i nowotworów. ",
          "Korzystając z takiego menu, na pewno nie będziesz narzekał na nudę! Posiłki wegetariańskie są syte, smaczne i zdrowe. Ich odpowiednie zbilansowanie sprawia, że codziennie spożywasz niezbędną ilość składników odżywczych. Dania wegetariańskie są pożywne, smaczne i jednocześnie zdrowe. ",
          "Jadłospis opiera się na różnorodności roślin, owoców, kasz, orzechów, nasion. Takie dania niejednokrotnie Cię zaskoczą! Menu zawiera sporą ilość błonnika, witamin, potasu, magnezu i nienasyconych kwasów tłuszczowych. Dba ono o odpowiedni dzienny bilans energetyczny. ",
          <span>
            <a href="https://afterfit-catering.pl/dieta-wegetarianska">
              Dieta wegetariańska
            </a>{" "}
            pozwala zadbać o odpowiednią kondycję, samopoczucie oraz o wagę. Co
            więcej, ograniczysz ryzyko zachorowania na choroby serca, cukrzycę,
            otyłość i nowotwory.{" "}
          </span>,
        ],
      },
      gorzowWielkopolski: {
        description: [
          <span>
            ...
            bije ostatnimi czasy rekordy popularności. Jeśli jesteś zdecydowany
            odstawić mięso, a dodatkowo zadbać o swoją sylwetkę, stan zdrowia,
            kondycję i samopoczucie, to takie menu będzie dla Ciebie idealne!
          </span>,
          "Jadłospis jest niezwykle zróżnicowany. Poszczególne posiłki bazują na różnorodności roślin, owoców, kasz, orzechów, nasion. Składniki te zawierają błonnik, witaminy, potas, magnez, nienasycone kwasy tłuszczowe. Całość idealnie wpisze się w potrzeby Twojego organizmu. ",
          "Menu wegetariańskie jest smaczne, pożywne i co najważniejsze, zdrowe. Odpowiednie zbilansowanie diety sprawi, że będziesz miał mnóstwo energii, a przy tym poczujesz się lekko. ",
          "Wegetarianizm ogranicza ryzyko zachorowania na choroby serca, cukrzycę, otyłość i nowotwory. Od teraz możesz jeść zdrowo i smacznie! Przekonaj się sam, jak pyszne są dania bezmięsne. ",
        ],
      },
      opole: {
        description: [
          <span>
            ...
            jest odpowiednia dla osób, które chcą odstawić mięso. Dania
            bezmięsne są różnorodne, smaczne i sycące. Pozwalają one poprawić
      ...
      kutno: {
        description: [
          <span>
            ...
            całkowicie eliminuje mięso i bazuje na różnorodności roślin, owoców,
            kasz, orzechów, nasion. Taka menu sprawi, że poczujesz się lekko,
            ale będziesz miał sporo energii i siły.{" "}
          </span>,
          "Dania z menu są sycące, smaczne, zdrowe i różnorodne. Zaskoczą Cię one wyjątkowym smakiem. Co istotne, dostarczą wszystko to, co niezbędne do organizmu. ",
          "Jadłospis jest odpowiednio zbilansowany i bogaty w błonnik, witaminy, potas, magnez, nienasycone kwasy tłuszczowe. Taka dieta gwarantuje zaspokojenie dziennego bilansu energetycznego. ",
          "Wegetarianizm pozwala cieszyć się szczupłą sylwetką, a jednocześnie minimalizuje ryzyko zachorowania na choroby serca, cukrzycę, otyłość i nowotwory. Mało tego, odczujesz znaczną poprawę swojej kondycji. ",
        ],
      },
      kielce: {
        description: [
          <span>
            Chcesz całkowicie odstawić mięso?{" "}
            <a href="https://afterfit-catering.pl/dieta-wegetarianska">
              Dieta wegetariańska
            </a>{" "}
            jest tym, czego potrzebujesz. Poszczególne dania są sycące, smaczne,
            zdrowe i różnorodne. Sam zobaczysz, ile energii dostarcza bezmięsne
            menu.{" "}
          </span>,
      ...
      plock: {
        description: [
          <span>
            Jeśli chcesz w końcu odstawić mięso, to{" "}
            <a href="https://afterfit-catering.pl/dieta-wegetarianska">
              dieta wegetariańska
            </a>{" "}
            będzie dla Ciebie idealna! Pokaże ona Tobie, jak smaczne,
            urozmaicone i pożywne mogą być dania opierające się na warzywach,
            owocach, kaszach, orzechach i nasionach!
          </span>,
      ...
      radom: {
        description: [
          ...
          <span>
            ...
            jest urozmaicona, a posiłki zachwycą Cię smakiem. Będziesz nimi
            zachwycony. Mało tego, poszczególne składniki zawierają błonnik,
            witaminy, potas, magnez, a więc dostarczysz organizmowi wszystko to,
            co najlepsze i niezbędne.{" "}
          </span>,
      ...
      wloclawek: {
        description: [
          <span>
            ...
            opiera się na całkowitym wyeliminowaniu mięsa z jadłospisu. Będzie
            ona idealna dla wszystkich osób, które chcą zmienić swoje nawyki
            żywieniowe i poczuć się lepiej.{" "}
          </span>,
      ...
      rzeszow: {
        description: [
          ...
          <span>
            ...
            pozwala ograniczyć ryzyko chorób serca, cukrzycy, otyłości i
            nowotworów. Mało tego, szybko odczujesz różnicę, jeśli chodzi o
            codzienne funkcjonowanie. Nic zatem dziwnego, że coraz więcej osób
            stawia na bezmięsne menu.
          </span>,
        ],
      },
      szczecin: {
        description: [
          ...
          <span>
            ...
            jest bogata w składniki odżywcze i dostarcza Ci wszystko to, co
            najlepsze i zdrowe dla organizmu. Co ważne, poszczególne posiłki
            zaspokajają dzienny bilans energetyczny.{" "}
          </span>,
      ...
      czestochowa: {
        description: [
          <span>
            ...
            pozwala wyeliminować mięso ze swojego codziennego menu. Nowe
            zwyczaje żywieniowe sprawią, że się poczujesz się zdrowiej i
            jednocześnie lepiej.{" "}
          </span>,
      ...
      bialystok: {
        description: [
          <span>
            Jeśli chcesz wyeliminować mięso ze swojego codziennego menu, to{" "}
            <a href="https://afterfit-catering.pl/dieta-wegetarianska">
              dieta wegetariańska
            </a>{" "}
            jest tym, czego szukasz. Jadłospis jest odpowiednio zbilansowany i
            zawiera pozwala dostarczać do organizmu niezbędną ilość składników
            odżywczych.
          </span>,
  ...
  },
  {
    ...
    dietId: 234,
    metaDescription:
      "Dieta dla osób, które chcą się zdrowo odżywiać i pragną ze swojego jadłospisu wyeliminować mięso nie rezygnując przy tym z ryb",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_3.jpg",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_9.jpg",
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dedykowana osobom, które nie spożywają mięsa ale nie chcą
            rezygnować z ryb czy owoców morza, które są doskonałym źródłem
            białka i kwasów omega - 3.
            <br /> <br />
            2. Dla wszystkich, którzy pragną zdrowo się odżywiać i zadbać o
            prawidłową masę ciała czy zrzucić zbędne kilogramy.
            <br /> <br />
          </span>
        ),
      },
  ...
  },
  {
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Dieta skierowana jest dla osób z nadmierną masą ciała oraz
    ...
    menu: {
      ...
      dinner:
        "Polędwiczki wieprzowe w sosie z zielonym pieprzem i surówką biało-czerwoną",
      supper:
        "Sałatka z szarpaną wieprzowiną, pomidorkami koktajlowymi i awokado.",
    },
    offerDescription:
      "Dieta wysokotłuszczowa, przeznaczona dla osób, które chcą w szybkim czasie zrzucić nadmierną tkankę tłuszczową.",
    cityDescription: {
      lodz: {
        description: [
  ...
  },
  {
    ...
    questions: {
      ...
      2: {
        ...
        answer: (
          <span>
            1. Skierowana dla osób chorych na nadciśnienie.
            <br /> <br />
            2. Dla osób z wysokim poziomem cholesterolu lub chorobami sercowo-
            naczyniowymi.
            <br /> <br />
            3. Dla osób, które chcą zrzucić zbędne kilogramy lub które chcą
            zmienić swoje dotychczasowe nawyki żywieniowe i zacząć zdrowo się
            odżywiać..
            <br /> <br />
          </span>
        ),
    ...
    menu: {
      ...
      dinner:
        "Klopsiki greckie z sosem tzatziki podane z kaszą jaglaną i grillowanymi\n" +
        "warzywami",
  ...
  },
  {
    ...
    dietId: 587,
    metaDescription:
      "Dieta domowa dla osób, które chcą smacznie i dobrze zjeść",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
  ...
  {
    dietUrl: "dieta-sirtfood",
    dietId: 588,
    metaDescription: "Dieta Adel dla osób, które chcą schudnąć",
    dietImg: "../images/diets/dieta-odchudzajaca.jpg",
    dietGallery: {
      1: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_sirt-1.png",
      2: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_sirt-2.png",
      3: "https://miscellaneous-images.s3.eu-central-1.amazonaws.com/afterfit_sirt-3.png",
    },
    fullName: "Dieta Sirtfood",
    questions: {
      1: {
        question: "Rozkład makroskładników",
        answer: "W tej diecie rozkład makroskładników nie ma znaczenia",
      },
      2: {
        question: "Dla kogo?",
        answer: (
          <span>
            1. Dla osób, które w szybkim tempie chcą zrzucić zbędne kilogramy.
            <br /> <br />
            2. Dla osób, które chcą zregenerować i odżywić swoj organizm przy
            jednoczesnej redukcji masy ciala.
            <br /> <br />
            3. Diety sirtuinowej nie powinny stosować kobiety w ciąży oraz
            karmiące piersią, ze względu na znaczne ograniczenia kaloryczne w
            pierwszych etapach diety. Dieta jest niewskazana również u osób
            chorych przewlekle m.in. na choroby układu pokarmowego. Dwa pierwsze
            etapy diety nie są wskazane również u osób bardzo aktywnych, ze
            względu na niską podaż energii.
            <br /> <br />
          </span>
        ),
      },
    ...
    menu: {
      dinner:
        "Pierś z kurczaka w jogurtowej marynacie z kolorową sałatką i kaszą gryczaną białą",
      coctail1: "Marchwiowo-jabłkowy sok sirtuinowy z matchą",
      coctail2: "Malinowy sok sirtuinowy z awokado na bazie zielonej herbaty ",
      coctail3: "Koktajl z ananasem i jagodami",
    },
    offerDescription:
      "Dieta dla osób, które w szybkim tempie chcą zrzucić zbędne kilogramy.",
    cityDescription: {
      lodz: {
        description: [
          "Dieta Sirt polega przede wszystkim na włączaniu do menu konkretnych produktów, bogatych w polifenole czyli silne przeciwutleniacze, których rolą jest ochrona komórek ciała przed działaniem wolnych rodników, wywołujących choroby i przedwczesne starzenie się organizmu. Polifenole są również aktywatorami białek SIRT (sirtuin), które mogą spowalniać proces starzenia się, chronić organizm przed chorobami, a także przyspieszać metabolizm oraz ułatwiać spalanie tkanki tłuszczowej.Celem diety Sirt jest szybka redukcja masy ciała przy jednoczesnym efekcie głębokiej regeneracji i odmłodzenia.",
          "Dieta sirt zakłada 4 etapy. Pierwszy etap diety trwa zwykle 1 do 3 dni i zakłada spożywanie 1000 kalorii. W skład menu wchodzą 3 koktajle i 1 posiłek sirtuinowy. Drugi etap diety zaczyna się od 4 dnia i trwa maksymalnie do 7 dnia diety.  W tym czasie jadamy nie więcej niż 1500 kcal. W skład menu wchodzą 2 koktajle sirtuinowe oraz 2 posiłki stałe. Trzeci etap diety trwa od 8 dnia, przez kolejne 14 dni. Ten etap to 1 koktajl oraz 3 posiłki bogate w sirtuiny. W ostatnim etapie diety nie ma określonej kaloryczności ani zaleceń co do rodzaju pokarmów, ważne jest, aby menu obfitowało w posiłki bogate w sirtuiny.",
        ],
      },
    },
  },
